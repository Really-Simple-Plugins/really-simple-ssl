...
if ( ! defined( 'BASE_PATH' ) ) {
	define( 'BASE_PATH', rsssl_find_wordpress_base_path() . '/' ); //phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedConstantFound
}
...
function rsssl_get_system_status() {
	...
	} elseif ( ! function_exists( 'stream_context_get_params' ) ) {
