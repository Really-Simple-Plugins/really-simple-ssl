...
//        }
        ...
        private function filter_vulnerabilities($vulnerabilities, $Version, $core = false): array
        {
            ...
            foreach ($vulnerabilities as $vulnerability) {
	            ...
	            if ($vulnerability->fixed_in !== 'not fixed' && version_compare(rsssl_remove_prefix_from_version($Version), rsssl_remove_prefix_from_version($vulnerability->fixed_in), '>=') ) {
		            continue;
	            }
                ...
                if (version_compare(rsssl_remove_prefix_from_version($Version), rsssl_remove_prefix_from_version($version_from), rsssl_remove_prefix_from_version($operator_from))
					&& version_compare(rsssl_remove_prefix_from_version($Version), rsssl_remove_prefix_from_version($version_to), rsssl_remove_prefix_from_version($operator_to))) {
