...
public function dismiss_htaccess_warning_callback() {
 ...
 public function add_settings_page() {
   ...
   RSSSL()->rsssl_admin_page = add_options_page(
     ...
     add_action('load-'.RSSSL()->rsssl_admin_page, array($this,'admin_add_help_tab'));
...
public function img($type) {
   ...
   */
   ...
   public function enqueue_assets($hook){
       ...
       if( (!is_network_admin() && ($hook != RSSSL()->rsssl_admin_page)) && $this->ssl_enabled )
           return;
