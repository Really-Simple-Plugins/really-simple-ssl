	...
	public static function admin_notices() {
		...
		if ( self::has_old_addon( 'really-simple-ssl-pro/really-simple-ssl-pro.php' ) ||
			...
			<div id="message" class="error notice really-simple-plugins">
				...
				<p>
					<?php printf( __( 'Visit the plugins overview or %1$srenew your license%2$s.', 'really-simple-ssl' ), '<a href="https://really-simple-ssl.com/pro/?mtm_campaign=renew&mtm_source=free&mtm_content=upgrade" target="_blank">', '</a>' ); ?>
				</p>
			</div>
			<?php
		}
