...
$this->fields = $this->fields + array(
        ...
        'disclosure_company' => array(
            ...
            'help'        => __( "For Germany and Austria, please refer to your Impressum, for other EU countries and the UK you can select a page where your company or personal details are described.",
                    'really-simple-ssl' ) . rsssl_read_more( 'https://complianz.io/definitions/what-are-statutory-and-regulatory-disclosures/' ),
...
$this->fields = $this->fields + array(
        ...
        'accessibility_content' => array(
            ...
            'help'     => __( 'Extend your document with a reference to your efforts toward accessibility.', 'really-simple-ssl' )
                . rsssl_read_more( 'https://complianz.io/definitions/what-is-wcag/' ),
            'options'  => $this->yes_no,
        ),
        ...
        'majeure_communication' => array(
            ...
            'help'     => __('Force majeure are occurrences beyond the reasonable control of a party and that will void liability', 'really-simple-ssl' ) . rsssl_read_more( 'https://complianz.io/what-is-force-majeure/' ),
            'options'  => $this->yes_no,
        ),
        ...
        'multilanguage_communication' => array(
            ...
            'help'   => __( 'This answer is pre-filled if a multilanguage plugin is available e.g. WPML or Polylang.', 'really-simple-ssl' )
                . rsssl_read_more( 'https://complianz.io/translating-terms-conditions/' ),
        ...
        'about_copyright' => array(
            ...
            'help'   => __( 'Want to know more about Creative Commons?', 'really-simple-ssl' )
                . rsssl_read_more( 'https://complianz.io/definitions/what-is-creative-commons/' ),
        ...
        'about_returns' => array(
            ...
            'default'  => '',
            'help'     => rsssl_read_more( 'https://complianz.io/about-return-policies/' ),
