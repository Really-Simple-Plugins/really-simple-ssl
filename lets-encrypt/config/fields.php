		...
		[
			...
			[
				...
				'help'     => [
					...
					'text'  => __( 'By selecting your hosting provider we can tell you if your hosting provider already supports free SSL, and/or where you can activate it.', 'really-simple-ssl' )
									. '&nbsp;' .
									sprintf(
										__( "If your hosting provider is not listed, and there's an SSL activation/installation link, please let us %1\$sknow%2\$s.", 'really-simple-ssl' ),
										'<a target="_blank" href="https://really-simple-ssl.com/install-ssl-certificate/#hostingdetails">',
										'</a>'
									),
				],
				'default'  => false,
			...
			[
				...
				'help'              => [
					...
					'text'  => sprintf(
						__( "You can find your api key %1\$shere%2\$s (make sure you're logged in with your main account).", 'really-simple-ssl' ),
						'<a target="_blank" href="https://platform.cloudways.com/api">',
						'</a>'
					),
				],
				'server_conditions' => [
