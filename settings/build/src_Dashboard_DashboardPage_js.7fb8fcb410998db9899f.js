...
const Vulnerabilities = () => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
    ...
    const s = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__._n)('You have 1 update pending', 'You have %s updates pending', updates, 'really-simple-ssl').replace('%s', updates);
    setUpdateWord(u);
...
//# sourceMappingURL=src_Dashboard_DashboardPage_js.7fb8fcb410998db9899f.js.map