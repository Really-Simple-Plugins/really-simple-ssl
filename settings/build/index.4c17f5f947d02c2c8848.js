...
const Header = () => {
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", null, menuItems.map((menu_item, i) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
    key: "menu-" + i
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    className: selectedMainMenuItem === menu_item.id ? 'active' : '',
    href: "#" + menu_item.id.toString()
  }, menu_item.title)))))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "rsssl-header-right"
  }, !rsssl_settings.le_generated_by_rsssl && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    className: "rsssl-knowledge-base-link",
    href: "https://really-simple-ssl.com/knowledge-base",
    target: "_blank",
    rel: "noopener noreferrer"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Documentation", "really-simple-ssl")), rsssl_settings.le_generated_by_rsssl && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: rsssl_settings.letsencrypt_url
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Let's Encrypt", "really-simple-ssl")), rsssl_settings.pro_plugin_active && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: "https://wordpress.org/support/plugin/really-simple-ssl/",
    className: "button button-black",
    target: "_blank",
    rel: "noopener noreferrer"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Support", "really-simple-ssl")), !rsssl_settings.pro_plugin_active && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: rsssl_settings.upgrade_link,
    className: "button button-black",
    target: "_blank",
    rel: "noopener noreferrer"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Go Pro", "really-simple-ssl")))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Settings_Notices__WEBPACK_IMPORTED_MODULE_3__["default"], {
...
const useOnboardingData = (0,zustand__WEBPACK_IMPORTED_MODULE_2__.create)((set, get) => ({
  ...
  activateSSL: () => {
    ...
    _utils_api__WEBPACK_IMPORTED_MODULE_0__.runTest('activate_ssl').then(async response => {
      set(state => ({
        processing: false
      }));
      ...
      if (response.success) {
        if (response.site_url_changed) {
          ...
          if (get().networkwide) {
            set(state => ({
              networkActivationStatus: 'main_site_activated'
            }));
          }
        }
        set({
  ...
  saveEmail: () => {
    get().setFooterStatus((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Updating email preferences..", "really-simple-ssl"));
    let data = {};
  ...
  updateItemStatus: (stepId, id, action, status, activated) => {
    const index = get().steps.findIndex(item => {
      return item.id === stepId;
    });
    const itemIndex = get().steps[index].items.findIndex(item => {
      return item.id === id;
    });
  ...
  pluginInstaller: async (id, action, title) => {
    ...
    get().setFooterStatus((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Installing %d...", "really-simple-ssl").replace("%d", title));
    ...
    if (nextAction !== 'none' && nextAction !== 'completed') {
      get().setFooterStatus((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Activating %d...", "really-simple-ssl").replace("%d", title));
  ...
  activateSSLNetworkWide: () => {
    ...
    if (typeof progress !== 'undefined') {
      get().setFooterStatus((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("%d% of subsites activated.").replace('%d', progress));
    }
    ...
    _utils_api__WEBPACK_IMPORTED_MODULE_0__.runTest('activate_ssl_networkwide').then(response => {
      if (response.success) {
        ...
        get().setFooterStatus((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("%d% of subsites activated.").replace('%d', response.progress));
...
const processAction = async (action, id) => {
  let data = {};
  data.id = id;
  return await _utils_api__WEBPACK_IMPORTED_MODULE_0__.doAction(action, data).then(async response => {
    if (response.success) {
...
/* harmony import */ var _Placeholder_PagePlaceholder__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Placeholder/PagePlaceholder */ "./src/Placeholder/PagePlaceholder.js");
...
/* harmony import */ var _Onboarding_OnboardingData__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Onboarding/OnboardingData */ "./src/Onboarding/OnboardingData.js");
...
/* harmony import */ var _utils_ErrorBoundary__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./utils/ErrorBoundary */ "./src/utils/ErrorBoundary.js");
...
const Page = () => {
  ...
  const {
    ...
    modalStatusLoaded
  } = (0,_Onboarding_OnboardingData__WEBPACK_IMPORTED_MODULE_7__["default"])();
  const {
    selectedMainMenuItem,
    fetchMenuData
  ...
  const [DashboardPage, setDashboardPage] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [Notices, setNotices] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [Menu, setMenu] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [ToastContainer, setToastContainer] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    rsssl_settings.json_translations.forEach(translationsString => {
      ...
      (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_9__.setLocaleData)(localeData, 'really-simple-ssl');
    });
  }, []);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (selectedMainMenuItem !== 'dashboard') {
      if (!Settings) {
        Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_react-tooltip_dist_react-tooltip_min_mjs"), __webpack_require__.e("vendors-node_modules_dompurify_dist_purify_js"), __webpack_require__.e("src_Settings_Settings_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./Settings/Settings */ "./src/Settings/Settings.js")).then(({
          default: Settings
        }) => {
      ...
      if (!Notices) {
        Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./Settings/Notices */ "./src/Settings/Notices.js")).then(({
          default: Notices
        }) => {
          setNotices(() => Notices);
        });
      ...
      if (!Menu) {
        __webpack_require__.e(/*! import() */ "src_Menu_Menu_js").then(__webpack_require__.bind(__webpack_require__, /*! ./Menu/Menu */ "./src/Menu/Menu.js")).then(({
          default: Menu
        }) => {
          setMenu(() => Menu);
        });
    ...
    if (selectedMainMenuItem === 'dashboard' && !DashboardPage) {
      Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_react-tooltip_dist_react-tooltip_min_mjs"), __webpack_require__.e("vendors-node_modules_dompurify_dist_purify_js"), __webpack_require__.e("src_Dashboard_DashboardPage_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./Dashboard/DashboardPage */ "./src/Dashboard/DashboardPage.js")).then(async ({
  ...
  const [OnboardingModal, setOnboardingModal] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (showOnboardingModal && !OnboardingModal) {
      Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_react-tooltip_dist_react-tooltip_min_mjs"), __webpack_require__.e("vendors-node_modules_dompurify_dist_purify_js"), __webpack_require__.e("vendors-node_modules_material-ui_core_esm_TextField_TextField_js-node_modules_mui_material_Au-7a48c7"), __webpack_require__.e("src_Onboarding_OnboardingModal_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./Onboarding/OnboardingModal */ "./src/Onboarding/OnboardingModal.js")).then(({
  ...
  const [Modal, setModal] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    if (showModal && !Modal) {
      Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_react-tooltip_dist_react-tooltip_min_mjs"), __webpack_require__.e("src_Modal_Modal_js")]).then(__webpack_require__.bind(__webpack_require__, /*! ./Modal/Modal */ "./src/Modal/Modal.js")).then(({
        default: Modal
      }) => {
        setModal(() => Modal);
      });
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    let subMenuItem = (0,_utils_getAnchor__WEBPACK_IMPORTED_MODULE_4__["default"])('menu');
  ...
  if (error) {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Placeholder_PagePlaceholder__WEBPACK_IMPORTED_MODULE_3__["default"], {
      error: error
    }));
  }
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "rsssl-wrapper"
  }, OnboardingModal && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_utils_ErrorBoundary__WEBPACK_IMPORTED_MODULE_10__["default"], {
    fallback: "Could not load onboarding modal"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(OnboardingModal, null)), Modal && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_utils_ErrorBoundary__WEBPACK_IMPORTED_MODULE_10__["default"], {
    fallback: "Could not load modal"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Modal, null)), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Header__WEBPACK_IMPORTED_MODULE_2__["default"], null), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "rsssl-content-area rsssl-grid rsssl-" + selectedMainMenuItem
  }, selectedMainMenuItem !== 'dashboard' && Settings && Menu && Notices && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_utils_ErrorBoundary__WEBPACK_IMPORTED_MODULE_10__["default"], {
    fallback: "Could not load menu"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Menu, null)), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_utils_ErrorBoundary__WEBPACK_IMPORTED_MODULE_10__["default"], {
    fallback: "Could not load settings"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Settings, null)), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_utils_ErrorBoundary__WEBPACK_IMPORTED_MODULE_10__["default"], {
    fallback: "Could not load notices"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Notices, {
    className: "rsssl-wizard-notices"
  }))), selectedMainMenuItem === 'dashboard' && DashboardPage && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_utils_ErrorBoundary__WEBPACK_IMPORTED_MODULE_10__["default"], {
    fallback: "Could not load menu"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(DashboardPage, null)))), ToastContainer && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(ToastContainer, {
...
const useFields = (0,zustand__WEBPACK_IMPORTED_MODULE_3__.create)((set, get) => ({
  ...
  handleNextButtonDisabled: nextButtonDisabled => {
    set({
      overrideNextButtonDisabled: nextButtonDisabled
    });
  },
  ...
  saveFields: async (skipRefreshTests, showSavedNotice) => {
    ...
    if (showSavedNotice && saveFields.length === 0) {
      ...
      react_toastify__WEBPACK_IMPORTED_MODULE_2__.toast.promise(Promise.resolve(), {
        success: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Settings saved', 'really-simple-ssl')
      });
    }
  },
...
const handleShowSavedSettingsNotice = (text, type) => {
  ...
  if (type === 'error') {
    react_toastify__WEBPACK_IMPORTED_MODULE_2__.toast.error(text);
  }
  if (type === 'warning') {
    react_toastify__WEBPACK_IMPORTED_MODULE_2__.toast.warning(text);
  }
  if (type === 'info') {
    react_toastify__WEBPACK_IMPORTED_MODULE_2__.toast.info(text);
  }
  if (type === 'success') {
...
const Error = props => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, props.error && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "rsssl-rest-error-message"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h3", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("A problem was detected during the loading of the settings", "really-simple-ssl")), description && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, description), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("The request returned the following errors:", "really-simple-ssl")), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", null, props.error.code && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Response code:", "really-simple-ssl"), "\xA0", props.error.code), props.error.data.status && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Status code:", "really-simple-ssl"), "\xA0", props.error.data.status), message && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Server response:", "really-simple-ssl"), "\xA0", message))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Hyperlink__WEBPACK_IMPORTED_MODULE_2__["default"], {
...
const Hyperlink = props => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, label_pre, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    className: className,
    target: props.target,
...
const apiGet = path => {
  if (usesPlainPermalinks()) {
    ...
    return axios__WEBPACK_IMPORTED_MODULE_2__["default"].get(siteUrl() + path, config).then(response => {
...
const apiPost = (path, data) => {
  if (usesPlainPermalinks()) {
    ...
    return axios__WEBPACK_IMPORTED_MODULE_2__["default"].post(siteUrl() + path, data, config).then(response => {
      return response.data;
    }).catch(error => {
...
/******/ 			return "" + chunkId + "." + {"vendors-node_modules_react-tooltip_dist_react-tooltip_min_mjs":"c9d9fd84064d8b201dab","vendors-node_modules_dompurify_dist_purify_js":"4f8db9f0d3940f222205","src_Settings_Settings_js":"8a9b6670bf75065b2e97","src_Menu_Menu_js":"3991e68681e40974bc6b","src_Dashboard_DashboardPage_js":"02edb20bb28480a686ed","vendors-node_modules_material-ui_core_esm_TextField_TextField_js-node_modules_mui_material_Au-7a48c7":"91d7cb87af0fd18a6d8a","src_Onboarding_OnboardingModal_js":"3ccd7b31a7849acd7ded","src_Modal_Modal_js":"cc2ced9acbe1ea2031e9","vendors-node_modules_react-data-table-component_dist_index_cjs_js-node_modules_react-select_d-52a53a":"56c18143ac10241b5939","src_Settings_Field_js":"6ad5ae0385d56148e00f","vendors-node_modules_material-ui_lab_esm_Autocomplete_index_js":"a07adca65e9370f834fc","vendors-node_modules_material-ui_core_esm_styles_index_js":"a8b5b3bd6cd7ef36aa0a"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 			var cssChunks = {"src_Onboarding_OnboardingModal_js":1,"src_Settings_Field_js":1};
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkreally_simple_ssl"] = globalThis["webpackChunkreally_simple_ssl"] || [];
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (container) {
    if (_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createRoot) {
      (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createRoot)(container).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Page__WEBPACK_IMPORTED_MODULE_2__["default"], null));
    } else {
      (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.render)((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Page__WEBPACK_IMPORTED_MODULE_2__["default"], null), container);
    }
  }
});
...
/******/ })()
;
//# sourceMappingURL=index.4c17f5f947d02c2c8848.js.map