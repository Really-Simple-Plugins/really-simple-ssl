...
const OtherPlugins = props => {
  ...
  const [dataUpdated, setDataUpdated] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
...
class Help extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  render() {
    ...
    let openStatus = this.props.noticesShown ? 'open' : ''; //we can use notice.linked_field to create a visual link to the field.
...
class Settings extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  render() {
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)("Toggle/hide all", "really-simple-ssl"))), notices.map((field, i) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Help__WEBPACK_IMPORTED_MODULE_4__["default"], {
      key: i,
      noticesShown: noticesShown,
      index: i,
      help: field,
