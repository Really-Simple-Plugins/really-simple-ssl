...
/* harmony import */ var _SecurityFeaturesBlock_SecurityFeaturesBlock__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./SecurityFeaturesBlock/SecurityFeaturesBlock */ "./src/DashBoard/SecurityFeaturesBlock/SecurityFeaturesBlock.js");
/* harmony import */ var _SecurityFeaturesBlock_SecurityFeaturesFooter__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./SecurityFeaturesBlock/SecurityFeaturesFooter */ "./src/DashBoard/SecurityFeaturesBlock/SecurityFeaturesFooter.js");
/* harmony import */ var _Placeholder_Placeholder__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../Placeholder/Placeholder */ "./src/Placeholder/Placeholder.js");
...
var dynamicComponents = {
  "SecurityFeaturesBlock": _SecurityFeaturesBlock_SecurityFeaturesBlock__WEBPACK_IMPORTED_MODULE_8__["default"],
  "SecurityFeaturesFooter": _SecurityFeaturesBlock_SecurityFeaturesFooter__WEBPACK_IMPORTED_MODULE_9__["default"],
...
class GridBlock extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  render() {
    ...
    }), blockData.controls && blockData.controls.type === 'react' && wp.element.createElement(dynamicComponents[blockData.controls.data], DynamicBlockProps))), !isAPILoaded && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Placeholder_Placeholder__WEBPACK_IMPORTED_MODULE_10__["default"], {
      lines: "4"
...
const ProgressFooter = props => {
  const [sslEnabled, setSslEnabled] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, !sslEnabled && certificateIsValid && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    onClick: () => startModal(),
    className: "button button-primary"
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, sslStatusText), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_utils_Icon__WEBPACK_IMPORTED_MODULE_4__["default"], {
    name: mixedContentIcon,
    color: mixedContentColor
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Mixed content", "really-simple-ssl")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_utils_Icon__WEBPACK_IMPORTED_MODULE_4__["default"], {
    name: redirectIcon,
    color: redirectColor
...
const SslLabs = props => {
    ...
    getSslLabsData().then(sslData => {
      ...
      if (sslData.endpoints && sslData.endpoints.filter(endpoint => endpoint.statusMessage === 'Ready').length > 0) {
        ...
        getEndpointData(ipAddress).then(response => {
          ...
          if (!sslData.errors) {
            _utils_api__WEBPACK_IMPORTED_MODULE_1__.updateSslLabs(sslData).then(response => {});
          }
  ...
  const getEndpointData = ipAddress => {
    return new Promise((resolve, reject) => {
      ...
      _utils_api__WEBPACK_IMPORTED_MODULE_1__.doAction('ssltest_run', url).then(response => {
  ...
  const hasHSTS = () => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, status === 'inactive' && scoreSnippet("rsssl-test-inactive", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("HSTS", "really-simple-ssl")), status === 'processing' && scoreSnippet("rsssl-test-processing", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("HSTS...", "really-simple-ssl")), status === 'error' && scoreSnippet("rsssl-test-error", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("No HSTS header", "really-simple-ssl")), status === 'success' && scoreSnippet("rsssl-test-success", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("HSTS header detected", "really-simple-ssl")));
  };
  ...
  */
  ...
  const certificateStatus = () => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, status === 'inactive' && scoreSnippet("rsssl-test-inactive", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("certificate", "really-simple-ssl")), status === 'processing' && scoreSnippet("rsssl-test-processing", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("certificate...", "really-simple-ssl")), status === 'error' && scoreSnippet("rsssl-test-error", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("certificate issue", "really-simple-ssl")), status === 'success' && scoreSnippet("rsssl-test-success", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("valid certificate", "really-simple-ssl")));
  };
  ...
  const supportsTlS11 = () => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, status === 'inactive' && scoreSnippet("rsssl-test-inactive", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Protocol support", "really-simple-ssl")), status === 'processing' && scoreSnippet("rsssl-test-processing", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Protocol support...", "really-simple-ssl")), status === 'error' && scoreSnippet("rsssl-test-error", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Supports TLS 1.1", "really-simple-ssl")), status === 'success' && scoreSnippet("rsssl-test-success", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("No TLS 1.1", "really-simple-ssl")));
  };
  ...
  }, statusMessage && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, scoreSnippet("rsssl-test-processing", ipAddress), scoreSnippet("rsssl-test-processing", statusMessage)), isLocalHost() && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, scoreSnippet("rsssl-test-processing", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Not available on localhost", "really-simple-ssl"))), supportsTlS11(), hasHSTS(), certificateStatus(), cipherStrength()), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("What does my score mean?", "really-simple-ssl"), "\xA0", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: url,
    target: "_blank"
...
const LetsEncrypt = props => {
  ...
  let currentAction = props.field.actions[actionIndex]; //filter out skipped actions
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    name: statuses[action.status].icon,
    color: statuses[action.status].color
...
const Onboarding = props => {
  ...
  const controlButtons = () => {
    ...
    if (steps[0].visible) {
      ...
      }, ActivateSSLText), certificateValid && !rsssl_settings.pro_active && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
        target: "_blank",
        href: rsssl_settings.upgrade_link,
        className: "button button-default"
...
/* harmony export */   "updateSslLabs": () => (/* binding */ updateSslLabs)
/* harmony export */ });
...
const getOnboarding = forceRefresh => {
  ...
  return axios__WEBPACK_IMPORTED_MODULE_0___default().get(rsssl_settings.site_url + 'reallysimplessl/v1/onboarding?forceRefresh=' + forceRefresh, config);
};
const updateSslLabs = data => {
  let config = {
    headers: {
      'X-WP-Nonce': rsssl_settings.nonce
    }
  };
  return axios__WEBPACK_IMPORTED_MODULE_0___default().post(rsssl_settings.site_url + 'reallysimplessl/v1/store_ssl_labs', data, config);
};
