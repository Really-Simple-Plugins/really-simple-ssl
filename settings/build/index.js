  ...
  const runSslTest = () => {
    getSslLabsData().then(sslData => {
      if (sslData.status === 'ERROR') {
        ...
        console.log("no ready endpoint"); //if there are no errors, this is the first request. We reset the endpoint data we have.
...
class MixedContentScan extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  render() {
    ...
    }, state !== 'running' && completedStatus === 'never' && (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("No records. Start your first scan", "really-simple-ssl"), state !== 'running' && completedStatus === 'completed' && (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Everything is now served over SSL", "really-simple-ssl")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  updateFieldsListWithConditions() {
    for (const field of this.props.fields) {
      ...
      if (previouslyDisabled && enabled) {
        ...
        if (!(0,_utils_lib__WEBPACK_IMPORTED_MODULE_1__.in_array)(field.id, changedFields)) {
