...
const OnboardingModal = () => {
  ...
  const parseStepItems = items => {
    return items.map((item, index) => {
      ...
      }, title, " ", button && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, "\xA0-\xA0", isLink && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
        isLink: true,
...
class ContentSecurityPolicy extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  toggleEnforce(e, enforce) {
    ...
    console.log(fields);
    let learning_mode_completed_field = fields.filter(field => field.id === 'csp_learning_mode_completed')[0]; //disable learning mode if enforced
  ...
  toggleLearningMode(e) {
    ...
    let field = fields.filter(field => field.id === 'csp_learning_mode')[0]; //enforce this setting
  ...
  render() {
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Enforce", "really-simple-ssl")), csp_enforce == 1 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
      className: "button",
    ...
    }), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Enable Learning Mode", "really-simple-ssl"))), csp_learning_mode == 1 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/* harmony import */ var _Support__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Support */ "./src/Settings/Support.js");
/* harmony import */ var _ContentSecurityPolicy__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ContentSecurityPolicy */ "./src/Settings/ContentSecurityPolicy.js");
/* harmony import */ var _Xmlrpc__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Xmlrpc */ "./src/Settings/Xmlrpc.js");
...
/* harmony import */ var react_data_table_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! react-data-table-component */ "./node_modules/react-data-table-component/dist/index.cjs.js");
...
class Field extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  render() {
    ...
    if (field.type === 'support') {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Support__WEBPACK_IMPORTED_MODULE_7__["default"], null);
    }
    ...
    if (field.type === 'xmlrpc') {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Xmlrpc__WEBPACK_IMPORTED_MODULE_9__["default"], {
        onChangeHandlerDataTable: this.onChangeHandlerDataTable,
        updateField: this.props.updateField,
        field: this.props.field,
        options: options,
    ...
    if (field.type === 'contentsecuritypolicy') {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_ContentSecurityPolicy__WEBPACK_IMPORTED_MODULE_8__["default"], {
        onChangeHandlerDataTable: this.onChangeHandlerDataTable,
        updateField: this.props.updateField,
        field: this.props.field,
        options: options,
    ...
    if (field.type === 'mixedcontentscan') {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_MixedContentScan__WEBPACK_IMPORTED_MODULE_5__["default"], {
...
class Xmlrpc extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor() {
    super(...arguments);
    this.state = {
      enforce: 0,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Xmlrpc);
