...
class GridBlock extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  render() {
    ...
    }), blockData.controls && blockData.controls.type === 'react' && wp.element.createElement(dynamicComponents[blockData.controls.data], DynamicBlockProps))), !isAPILoaded && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Placeholder_Placeholder__WEBPACK_IMPORTED_MODULE_11__["default"], {
      lines: "4"
...
const SslLabs = props => {
  ...
  const getEndpointData = ipAddress => {
    const host = window.location.host; //         const host = "rssslletsencrypt.nl";
  ...
  */
  ...
  const certificateStatus = () => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, status === 'inactive' && scoreSnippet("rsssl-test-inactive", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Certificate", "really-simple-ssl")), status === 'processing' && scoreSnippet("rsssl-test-processing", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Certificate...", "really-simple-ssl")), status === 'error' && !hasErrors && scoreSnippet("rsssl-test-error", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Certificate issue", "really-simple-ssl")), status === 'success' && scoreSnippet("rsssl-test-success", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Valid certificate", "really-simple-ssl")));
  };
...
class TaskElement extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  render() {
    let notice = this.props.notice; //treat links to rsssl.com and internal links different.
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("More info", "really-simple-ssl")), !urlIsExternal && notice.output.url && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      className: "rsssl-task-enable button button-secondary",
      href: notice.output.url
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Fix", "really-simple-ssl")), notice.output.highlight_field_id && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
      className: "rsssl-task-enable button button-secondary",
...
class LearningMode extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  componentDidMount() {
    ...
    let learning_mode_completed = field.value === 'completed'; //we somehow need this to initialize the field. Otherwise it doesn't work on load. need to figure that out.
...
class MixedContentScan extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  componentDidMount() {
    ...
    let action = '';
    let state = 'stop';
    let completedStatus = 'never'; //         this.getScanData = this.getScanData.bind(this);
  ...
  render() {
    ...
    }, state !== 'running' && completedStatus === 'never' && (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("No scan completed yet. Check for mixed content by running a scan.", "really-simple-ssl"), state !== 'running' && completedStatus === 'completed' && (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("No mixed content found!", "really-simple-ssl")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "rsssl-mixed-content-placeholder"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null))), data.length > 0 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_data_table_component__WEBPACK_IMPORTED_MODULE_1__["default"], {
      columns: columns,
      data: data,
      dense: true,
      pagination: true,
