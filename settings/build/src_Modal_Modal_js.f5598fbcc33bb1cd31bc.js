...
/* harmony import */ var _ModalData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ModalData */ "./src/Modal/ModalData.js");
...
const Modal = props => {
  ...
  const [buttonsDisabled, setButtonsDisabled] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useState)(false);
  const dismissModal = () => {
  ...
  const handleFix = (e, type) => {
    ...
    _utils_api__WEBPACK_IMPORTED_MODULE_2__.runTest(action, 'refresh', modalData).then(response => {
      let data = {
        ...modalData
      };
  ...
  }, modalData.title), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    type: "button",
  ...
  }, modalData.subtitle && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "rsssl-modal-subtitle"
  }, modalData.subtitle), Array.isArray(description) && description.map((s, i) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: "modalDescription-" + i,
    className: "rsssl-modal-description"
  }, s))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "rsssl-modal-footer"
  }, modalData.edit && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: modalData.edit,
    target: "_blank",
    rel: "noopener noreferrer",
    className: "button button-secondary"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Edit", "really-simple-ssl")), modalData.help && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: modalData.help,
    target: "_blank",
    rel: "noopener noreferrer",
    className: "button rsssl-button-help"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Help", "really-simple-ssl")), !modalData.ignored && modalData.action === 'ignore_url' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    disabled: disabled,
    className: "button button-primary",
    onClick: e => handleFix(e, 'ignore')
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Ignore", "really-simple-ssl")), modalData.action !== 'ignore_url' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    disabled: disabled,
    className: "button button-primary",
...
//# sourceMappingURL=src_Modal_Modal_js.f5598fbcc33bb1cd31bc.js.map