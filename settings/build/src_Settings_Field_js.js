...
const Field = props => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    let anchor = (0,_utils_getAnchor__WEBPACK_IMPORTED_MODULE_22__["default"])('anchor');
...
const RiskComponent = props => {
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("You can choose to automate the most common actions for a vulnerability. Each action is set to a minimum risk level, similar to the notifications. Please read the instructions to read more about the process.", "really-simple-ssl")), DataTable && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(DataTable, {
    columns: columns,
    data: Object.values(data),
    theme: theme
  }));
