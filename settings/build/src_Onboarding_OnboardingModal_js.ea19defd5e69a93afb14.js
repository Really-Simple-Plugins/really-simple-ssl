...
/* harmony import */ var _OnboardingButtons__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./OnboardingButtons */ "./src/Onboarding/OnboardingButtons.js");
...
const Onboarding = _ref => {
  ...
  }), isModal && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_OnboardingButtons__WEBPACK_IMPORTED_MODULE_11__["default"], null))));
};
...
const OnboardingButtons = _ref => {
  ...
  if (currentStepIndex === 0) {
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Improve Security with PRO", "really-simple-ssl")), !certificateValid && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
      className: "rsssl-modal-default",
      onClick: () => {
        goToLetsEncrypt();
      }
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Install SSL", "really-simple-ssl")));
  }
  if (currentStepIndex > 0 && currentStepIndex < steps.length - 1) {
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Save and continue', 'really-simple-ssl')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
      disabled: processing,
      className: "rsssl-modal-default",
      onClick: () => {
        setCurrentStepIndex(currentStepIndex + 1);
  ...
  if (steps.length - 1 === currentStepIndex) {
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Dismiss', 'really-simple-ssl')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
      isPrimary: true,
      onClick: () => {
        goToDashboard();
      }
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Go to Dashboard', 'really-simple-ssl')));
  }
};
/* harmony default export */ __webpack_exports__["default"] = (OnboardingButtons);
...
/* harmony import */ var _OnboardingButtons__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./OnboardingButtons */ "./src/Onboarding/OnboardingButtons.js");
...
const OnboardingModal = () => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_modal_src_components_Modal_RssslModal__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ...
    setOpen: setOpen,
    buttons: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_OnboardingButtons__WEBPACK_IMPORTED_MODULE_9__["default"], null)
  }));
};
...
//# sourceMappingURL=src_Onboarding_OnboardingModal_js.ea19defd5e69a93afb14.js.map