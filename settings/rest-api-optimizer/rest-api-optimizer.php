...
if ( !defined('rsssl_rest_api_optimizer') && !rsssl_get_wp_option('rsssl_rest_api_optimizer_not_writable') ) {
	...
	if ( is_writable(WPMU_PLUGIN_DIR) ){
		...
		rsssl_update_wp_option('rsssl_rest_api_optimizer_not_writable', true );
	}
}
