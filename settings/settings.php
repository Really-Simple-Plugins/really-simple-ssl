...
function rsssl_plugin_admin_scripts()
{
    ...
    wp_localize_script(
        ...
        apply_filters('rsssl_localize_script', [
            ...
            'networkwide_active'    => ! is_multisite() || rsssl_is_networkwide_active(),
            //true for single sites and network wide activated
...
function rsssl_other_plugins_data($slug = false)
{
    ...
    $plugins = array(
        [
            ...
            'title'            => 'Burst Statistics - '.__("Self-hosted and privacy-friendly analytics tool.",
                    'really-simple-ssl'),
        ],
        [
            'slug'             => 'complianz-gdpr',
