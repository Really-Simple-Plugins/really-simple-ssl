...
//					'upgrade'              => 'https://really-simple-ssl.com/pro/?mtm_campaign=cops&mtm_source=free&mtm_content=upgrade',
					...
					'menu_items'           => 				[
						...
						[
							...
							'intro'      => __( 'Let\'s Encrypt.',
								'really-simple-ssl' ),
							'helpLink'   => 'https://really-simple-ssl.com/about-lets-encrypt/?mtm_campaign=letsencrypt&mtm_source=free',
						],
//						[
//							'id'         => 'menu-item-testthree',
//							'group_id'   => 'menu-items-group-three',
//							'title'      => __( 'Test3', 'really-simple-ssl' ),
//							'intro'      => __( 'Test3.',
//								'really-simple-ssl' ),
//							'helpLink'   => 'https://really-simple-ssl.com/about-lets-encrypt/?mtm_campaign=letsencrypt&mtm_source=free',
//						],
//						[
//							'id'         => 'menu-item-testfour',
//							'group_id'   => 'menu-items-group-four',
//							'title'      => __( 'Test4', 'really-simple-ssl' ),
//							'intro'      => __( 'Test4.',
//								'really-simple-ssl' ),
//							'helpLink'   => 'https://really-simple-ssl.com/about-lets-encrypt/?mtm_campaign=letsencrypt&mtm_source=free',
//						],
...
//			],
				...
				[
					...
					'premium_text'         => __( 'Get Cross Origin Policy Headers with %sReally Simple SSL Pro%s', 'really-simple-ssl' ),
					'upgrade'              => 'https://really-simple-ssl.com/pro/?mtm_campaign=cops&mtm_source=free&mtm_content=upgrade',
					'title'                => 'Multi menu test',
					'helpLink'             => 'https://really-simple-ssl.com/instructions/cross-origin-policies/?mtm_campaign=instructions&mtm_source=free',
					'menu_items'           => 				[
						'menu_items'           => 				[
							'id'         => 'menu-item-testtwo',
							'group_id'   => 'menu-items-group-two',
							'title'      => __( 'Test2', 'really-simple-ssl' ),
							'intro'      => __( 'Test2.',
								'really-simple-ssl' ),
							'helpLink'   => 'https://really-simple-ssl.com/about-lets-encrypt/?mtm_campaign=letsencrypt&mtm_source=free',
						],
