				...
				[
					...
					'menu_items' => [
						...
						[
							...
							'premium'              => true,
							'networkwide_required' => true,
							'premium_text'         => __( "HSTS forces browsers always to load a website via HTTPS. It removes unnecessary redirects and prevents manipulation of data originating from or sent to your website, including credentials.", 'really-simple-ssl' ),
				...
				[
					...
					'menu_items' => [
						...
						[
							...
							'premium_text' => __( "Hardening features are specifically designed for WordPress and reduce possible vulnerabilities by disallowing unused WordPress features, and strengthening defenses against potential attacks and threats.", 'really-simple-ssl' ),
						...
						[
							...
							'premium_title'     => __( 'XML-RPC with Reporting Mode', 'really-simple-ssl' ),
							'premium'   => true,
