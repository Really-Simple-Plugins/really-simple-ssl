				...
				[
                    ...
                    'groups'  => [
                        [
                            'id'       => 'two_fa_general',
                            'premium'              => true,
                            'premium_text'         => __( "Get Login Security with %sReally Simple SSL Pro%s", 'really-simple-ssl' ),
                        ...
                        [
                            ...
                            'intro'    => __( 'Enable and configure login security using e-mail.', 'really-simple-ssl' ),
                        ],
                        [
                            'id'       => 'two_fa_users',
                            'premium'              => true,
