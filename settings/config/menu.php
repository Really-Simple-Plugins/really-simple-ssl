...
function rsssl_menu() {
	...
	$menu_items = [
		...
		[
			...
			'menu_items'     => [
				[
					...
					'groups'   => [
						...
						[
							...
							'intro'         => __(
								'The following information is attached when you send this form: license key, scan results, your domain, .htaccess file, debug log and a list of active plugins.',
								'really-simple-ssl'
							),
							'premium'       => true,
							'premium_text'  => __(
								'Get Premium Support with %1$sReally Simple SSL Pro%2$s',
								'really-simple-ssl'
							),
				...
				[
					...
					'groups'   => [
						...
						[
							...
							'premium_text' => __(
								'Get Advanced Hardening with %1$sReally Simple SSL Pro%2$s',
								'really-simple-ssl'
							),
						],
						[
							...
							'premium_text' => __( 'Get XML-RPC with %1$sReally Simple SSL Pro%2$s', 'really-simple-ssl' ),
						],
					],
				],
				[
					...
					'groups'   => [
						[
							...
							'title'    => __( 'Vulnerabilities', 'really-simple-ssl' ),
							'intro'    => __(
								'Here you can configure vulnerability detection, notifications and measures. To learn more about the features displayed, please use the instructions linked in the top-right corner.',
								'really-simple-ssl'
							),
						],
						[
							...
							'intro'    => __(
								'These notifications are set to the minimum risk level that triggers a notification. For example, the default site-wide notification triggers on high-risk and critical vulnerabilities.',
								'really-simple-ssl'
							),
						],
						[
							...
							'intro'    => __(
								'This is the vulnerability overview. Here you will find current known vulnerabilities on your system. You can find more information and helpful, actionable insights for every vulnerability under details.',
								'really-simple-ssl'
							),
						],
						[
							...
							'intro'        => __(
								'You can choose to automate the most common actions for a vulnerability. Each action is set to a minimum risk level, similar to the notifications. Please read the instructions to learn more about the process.',
								'really-simple-ssl'
							),
							'premium_text' => __(
								'Improve Security with %1$sReally Simple SSL Pro%2$s',
								'really-simple-ssl'
							),
						],
					],
				...
				[
					...
					'groups'   => [
						[
							...
							'premium_text' => __(
								'Get Limit Login Attempts with %1$sReally Simple SSL Pro%2$s',
								'really-simple-ssl'
							),
						],
						[
							...
							'intro'        => __(
								'.feugait aptent adhuc conceptam risus regione epicurei ne litora simul suspendisse magna luctus risus senserit inceptos omittantur tritani iisque scripta pri fabellas latine dicant sale',
								'really-simple-ssl'
							),
							'premium_text' => __(
								'Get Limit Login Attempts with %1$sReally Simple SSL Pro%2$s',
				...
				[
					...
					'premium_text' => __(
						'Get the Mixed Content Scan with %1$sReally Simple SSL Pro%2$s',
						'really-simple-ssl'
					),
					'groups'       => [
						[
				...
				[
					...
					'groups'  => [
						[
							...
							'premium'              => true,
							'premium_text'         => __(
								'Get Recommended Security Headers with %1$sReally Simple SSL Pro%2$s',
								'really-simple-ssl'
							),
				...
				[
					...
					'groups'  => [
						[
							...
							'networkwide_required' => true,
							'premium_text'         => __(
								'Get HTTP Strict Transport Security with %1$sReally Simple SSL Pro%2$s',
								'really-simple-ssl'
							),
				...
				[
					...
					'groups'  => [
						[
							'id'                   => 'permissions_policy',
							'premium_text'         => __(
								'Get the Permissions Policy with %1$sReally Simple SSL Pro%2$s',
								'really-simple-ssl'
							),
				...
				[
					...
					'groups'  => [
						[
							...
							'premium'              => true,
							'premium_text'         => __(
								'Get Upgrade Insecure Requests with %1$sReally Simple SSL Pro%2$s',
								'really-simple-ssl'
							),
						...
						[
							...
							'premium'              => true,
							'premium_text'         => __(
								'Get Frame Ancestors with %1$sReally Simple SSL Pro%2$s',
								'really-simple-ssl'
							),
						...
						[
							...
							'premium'              => true,
							'premium_text'         => __(
								'Get Source Directives with %1$sReally Simple SSL Pro%2$s',
								'really-simple-ssl'
							),
				...
				[
					...
					'premium'              => true,
					'premium_text'         => __(
						'Get Cross Origin Policy Headers with %1$sReally Simple SSL Pro%2$s',
						'really-simple-ssl'
					),
				...
				[
					...
					'networkwide_required' => true,
					'premium'              => true,
					'premium_text'         => __( 'Get two-factor authentication with %1$sReally Simple SSL Pro%2$s', 'really-simple-ssl' ),
					'upgrade'              => 'https://really-simple-ssl.com/pro/?mtm_campaign=cops&mtm_source=free&mtm_content=upgrade',
					...
					'groups'               => [
						[
							'id'           => 'two_fa_general',
							'premium'      => true,
							'premium_text' => __( 'Get Login Protection with %1$sReally Simple SSL Pro%2$s', 'really-simple-ssl' ),
		...
		[
			...
			'intro'          => sprintf(
				__(
					'We have tried to make our Wizard as simple and fast as possible. Although these questions are all necessary, if there’s any way you think we can improve the plugin, please let us %1$sknow%2$s!',
					'really-simple-ssl'
				),
				...
				'</a>'
								...
								sprintf(
									__(
										' Please note that you can always save and finish the wizard later, use our %1$sdocumentation%2$s for additional information or log a %3$ssupport ticket%4$s if you need our assistance.',
										'really-simple-ssl'
									),
			...
			'menu_items'     => [
				[
					...
					'intro'      => __(
						'Letʼs Encrypt is a free, automated and open certificate authority brought to you by the nonprofit Internet Security Research Group (ISRG).',
						'really-simple-ssl'
					),
				...
				[
					...
					'intro' => __(
						'Below you will find the instructions for different hosting environments and configurations. If you start the process with the necessary instructions and credentials the next view steps will be done in no time.',
						'really-simple-ssl'
					),
				],
				[
