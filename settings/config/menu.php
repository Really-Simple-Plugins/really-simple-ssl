					...
					'groups'   => [
						...
						[
							...
							'intro'         => __('The following information is attached when you send this form: license key, scan results, your domain, .htaccess file, debug log and a list of active plugins.',
								'really-simple-ssl'),
							'premium'       => true,
							'premium_text'  => __("Elevate your security with our Premium Support! Our expert team ensures simple, hassle-free assistance whenever you need it. Stay confidently secure with our awesome support by your side",
								'really-simple-ssl'),
							'premium_title' => __('Get Premium Support', 'really-simple-ssl'),
				...
				[
					...
					'menu_items' => [
						...
						[
							...
							'premium_text' => __( "Get the Mixed Content Scan with Really Simple SSL Pro", 'really-simple-ssl' ),
				...
				[
					...
					'menu_items' => [
						[
							...
							'premium'              => true,
							'premium_text'         => __( "Get Recommended Security Headers with Really Simple SSL Pro", 'really-simple-ssl' ),
						...
						[
							...
							'premium'              => true,
							'networkwide_required' => true,
							'premium_text'         => __( "Get HTTP Strict Transport Security with Really Simple SSL Pro", 'really-simple-ssl' ),
...
//							'intro' => __( 'HSTS Security Headers', 'really-simple-ssl' ),
						...
						[
							...
							'premium_text'         => __( "Get the Permissions Policy with Really Simple SSL Pro", 'really-simple-ssl' ),
						...
						[
							...
							'groups'  => [
								[
									...
									'networkwide_required' => true,
									'premium'              => true,
									'premium_text'         => __( "Get Upgrade Insecure Requests with Really Simple SSL Pro", 'really-simple-ssl' ),
								...
								[
									...
									'networkwide_required' => true,
									'premium'              => true,
									'premium_text'         => __( "Get Frame Ancestors with Really Simple SSL Pro", 'really-simple-ssl' ),
								...
								[
									...
									'premium'              => true,
									'premium_text'         => __( "Get Source Directives with Really Simple SSL Pro", 'really-simple-ssl' ),
						...
						[
							...
							'networkwide_required' => true,
							'premium'              => true,
							'premium_text'         => __( 'Get Cross Origin Policy Headers with Really Simple SSL Pro', 'really-simple-ssl' ),
						...
						[
							...
							'groups'  => [
								...
								[
									...
									'premium_text' => __( "Improve Security with Really Simple SSL Pro", 'really-simple-ssl' ),
								],
							],
						],
					],
				...
				[
					...
					'menu_items' => [
						...
						[
							...
							'premium_text' => __( "Get Advanced Hardening with Really Simple SSL Pro", 'really-simple-ssl' ),
						],
						[
							'id'        => 'hardening-xml',
							...
							'premium_text' => __( "Get XML-RPC with Really Simple SSL Pro", 'really-simple-ssl' ),
						],
					],
				],
				[
