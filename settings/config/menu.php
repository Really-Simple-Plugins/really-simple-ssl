				...
				[
					...
					'menu_items' => [
						...
						[
							...
							'premium_text'         => __( "Control browser features that could allow third parties misuse data collected by microphone, camera, GEO Location etc, when enabled for your website.", 'really-simple-ssl' ),
						...
						[
							...
							'groups'  => [
								[
									...
									'premium'              => true,
									'premium_text'         => __( "Start login protection by adding an additional layer during authentication. This will leave authentication less dependent on just a password a single password. Want to force strong passwords? Check out Password Security.", 'really-simple-ssl' ),
