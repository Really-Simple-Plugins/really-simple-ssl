                ...
                [
                    ...
                    'groups'  => [
                        ...
                        [
                            ...
                            'title'        => __( 'Advanced Vulnerabilities', 'really-simple-ssl' ),
...
function rsssl_fields( $load_values = true ) {
	...
	$fields = [
        ...
        [
            'id'       => 'vulrpc_status_lm_enabled_once',
            'menu_id'  => 'vulnerabilities',
            'group_id' => 'hardening_measures',
            'type'     => 'hidden',
            'label'    => '',
            'disabled' => false,
            'default'  => false,
        ...
        [
            'id'               => 'vulnerable_data_versions',
            'control_field'    => 'vulrpc_status',
            'menu_id'          => 'vulnerabilities',
            ...
            'disabled'         => false,
            'default'          => false,
            'data_source'      => [ 'RSSSL', 'placeholder', 'vulnerable_plugins_data' ],
            'react_conditions' => [
                'relation' => 'AND',
                [
                    'disable_vulrpc' => false,
                ]
            ],
            'columns'          => [
                [
