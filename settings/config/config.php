...
function rsssl_fields( $load_values = true ) {
	...
	$fields = [
		...
		[
			...
			'email'            => [
				...
				'message'   => __(
					'The .htaccess redirect has been enabled on your site. If the server configuration is non-standard, this might cause issues. Please check if all pages on your site are functioning properly.',
					'really-simple-ssl'
				),
		...
		[
			...
			'default'          => false,
			'tooltip'          => __(
				'Only enable if the default mixed content fixer does not fix your front-end mixed content.',
				'really-simple-ssl'
			),
			'react_conditions' => [
				'relation' => 'AND',
		...
		[
			...
			'help'        => [
				...
				'text'  => __(
					'Hardening features limit the possibility of potential weaknesses and vulnerabilities which can be misused.',
					'really-simple-ssl'
				),
			],
			'recommended' => true,
		...
		[
			...
			'type'        => 'checkbox',
			'tooltip'     => __(
				'By default, WordPress shows if a username or email address exists when a login fails. This will change it to generic feedback.',
				'really-simple-ssl'
			),
		...
		[
			...
			'email'    => [
				...
				'message'   => sprintf(
					__(
						"As a security precaution, the username ‘admin’ has been changed on %1\$s. From now on, you can login with '%2\$s' or an email address.",
						'really-simple-ssl'
					),
					'{site_url}',
					'{username}'
			...
			'tooltip'  => __(
				"If the username 'admin' currently exists, you can rename it here. Please note that you can no longer use this username, and should use the new username or an email address",
				'really-simple-ssl'
			),
			'disabled' => false,
			'default'  => false,
		...
		[
			...
			'type'     => 'checkbox',
			'tooltip'  => __(
				'This will limit or fully disable HTTP requests that are not needed, but could be used with malicious intent.',
				'really-simple-ssl'
			),
		...
		[
			...
			'email'    => [
				...
				'message' => __(
					'Security through obscurity. Your site is no longer using the default wp_ prefix for database tables. The process has been designed to only complete and replace the tables after all wp_ tables are successfully renamed. In the unlikely event that this does lead to database issues on your site, please navigate to our troubleshooting article.',
					'really-simple-ssl'
				),
				'url'     => 'https://really-simple-ssl.com/instructions/database-issues-after-changing-prefix/',
			],
			'tooltip'  => __(
				'This will permanently change your database prefixes and you can NOT rollback this feature. Please make sure you have a back-up.',
				'really-simple-ssl'
			),
			'warning'  => __(
				'This will permanently change your database prefixes and you can NOT rollback this feature. Please make sure you have a back-up.',
		...
		[
			...
			'type'     => 'checkbox',
			'tooltip'  => __(
				'A debug.log is publicly accessibile and has a standard location. This will change the location to a randomly named folder in /wp-content/',
				'really-simple-ssl'
			),
			'email'    => [
				'title'   => __( 'Settings update: Debug.log file relocated', 'really-simple-ssl' ),
				'message' => __(
					'From now on, the debug.log won’t be publicly accessible whenever wp-debugging is enabled. The debug log will be stored in a randomly named folder in /wp-content/. This prevents possible leakage of sensitive debugging information.',
					'really-simple-ssl'
				),
		...
		[
			...
			'email'    => [
				...
				'message' => __(
					'Your login URL has changed to {login_url} to prevent common bot attacks on standard login URLs. Learn more about this feature, common questions and measures to prevent any issues.',
					'really-simple-ssl'
				),
		...
		[
			...
			'type'             => 'postdropdown',
			'tooltip'          => __(
				'Users trying to enter via /wp-admin or /wp-login.php will be redirected to this URL.',
				'really-simple-ssl'
			),
			'label'            => '',
			'disabled'         => false,
		...
		[
			...
			'tooltip'  => __(
				'This feature depends on multiple standard background processes. If a process fails or is unavailable on your system, detection might not work. We run frequent tests for this purpose. We will notify you accordingly if there are any issues.',
				'really-simple-ssl'
			),
			'disabled' => false,
			'default'  => false,
		...
		[
			...
			'group_id'         => 'vulnerabilities_basic',
			'tooltip'          => __(
				"If there's a vulnerability, you will also get feedback on the themes and plugin overview.",
				'really-simple-ssl'
			),
			'warning'          => false,
			'type'             => 'checkbox',
		...
		[
			...
			'tooltip'          => __(
				'This will send emails about vulnerabilities directly from your server. Make sure you can receive emails by the testing a preview below. If this feature is disabled, please enable notifications under general settings.',
				'really-simple-ssl'
			),
			'warning'          => true,
			'disabled'         => false,
		...
		[
			...
			'tooltip'          => __(
				'Test notifications can be used to test email delivery and shows how vulnerabilities will be reported on your WordPress installation.',
				'really-simple-ssl'
			),
			'disabled'         => false,
		...
		[
			...
			'type'             => 'checkbox',
			'label'            => __(
				'I have read and understood the risks to intervene with these measures.',
				'really-simple-ssl'
			),
			'comment'          => '<a href="https://really-simple-ssl.com/instructions/about-vulnerabilities#measures" target="_blank">' . __(
				'Read more',
				'really-simple-ssl'
			) . '</a>',
			'disabled'         => false,
		...
		[
			...
			'help'     => [
				...
				'text'  => __(
					'This feature will limit the number of login attempts per user. If a user exceeds the number of allowed attempts, the user will be blocked for a certain amount of time. You can also block IP addresses and view a list of blocked users and IP addresses.',
					'really-simple-ssl'
				),
			],
		],
		...
		[
			...
			'help'     => [
				...
				'text'  => __(
					'These security headers are the fundamental security measures to protect your website visitors while visiting your website.',
					'really-simple-ssl'
				),
			],
		],
		...
		[
			...
			'options'  => [
				'disabled'                        => __( 'Off', 'really-simple-ssl' ),
				'strict-origin-when-cross-origin' => 'strict-origin-when-cross-origin' . ' (' . __(
					'recommended',
					'really-simple-ssl'
				) . ')',
		...
		[
			...
			'comment'                 => sprintf(
				__(
					'After enabling this feature, you can submit your site to %1$shstspreload.org%2$s',
					'really-simple-ssl-pro'
				),
				'<a target="_blank" href="https://hstspreload.org?domain=' . site_url() . '">',
				'</a>'
			),
			'react_conditions'        => [
				'relation' => 'AND',
		...
		[
			...
			'help'     => [
				...
				'text'  => __(
					'The extensive mixed content scan will list all current and future issues and provide a fix, or instructions to fix manually.',
					'really-simple-ssl'
				),
			],
			'columns'  => [
		...
		[
			...
			'help'     => [
				...
				'text'  => __(
					'Browser features are plentiful, but most are not needed on your website.',
					'really-simple-ssl'
				) . ' ' . __(
					'They might be misused if you don’t actively tell the browser to disable these features.',
					'really-simple-ssl'
				),
			],
			'columns'  => [
		...
		[
			...
			'help'             => [
				...
				'text'  => __(
					'The content security policy has many options, so we always recommend starting in ‘learning mode’ to see what files and scripts are loaded.',
					'really-simple-ssl'
				),
			],
			'react_conditions' => [
	...
	foreach ( $fields as $key => $field ) {
		...
		if ( $load_values ) {
			...
			$value                = rsssl_sanitize_field(
				rsssl_get_option( $field['id'], $field['default'] ),
				$field['type'],
				$field['id']
			);
