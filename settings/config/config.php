        ...
        [
            ...
            'default'     => false,
						'help'        => [
							...
							'text' => __( 'The content security policy has many options, so we always recommend starting in ‘learning mode’ to see what files and scripts are loaded.', 'really-simple-ssl' ). rsssl_read_more('https://really-simple-ssl.com/definition/what-is-a-content-security-policy/'),
						],
        ],
		[
