 ...
 * @return array[]
 */
function get_items_for_new_installs ($ssl_detected) {
    $items = [
        [
    ...
    } else if ( !function_exists('stream_context_get_params') || RSSSL()->rsssl_certificate->detection_failed() ) {
        $items[] = [
...
function rsssl_get_onboarding_fields() {
    ...
    $itemsAndButtons = get_items_for_new_installs($ssl_detected);
    $steps[] = [
