...
function rsssl_fields( $load_values = true ) {
	...
	$fields = [
		...
		[
			...
			'tooltip'  => __( "This will block attempts of creating administrators outside of the native user creation process by WordPress.", 'really-simple-ssl' ),
			'help'               => [
				'label' => 'default',
			...
			'label'    => __( "Prevent unauthorized creation of administrators.", 'really-simple-ssl' ),
			'disabled' => false,
			'default'  => false,
		],
        [
