				...
				[
					...
					'groups'   => [
						...
						[
							...
							'intro'         => __( 'When you send this form, we will attach the following information: license key, scan results, your domain, .htaccess file, debug log and a list of active plugins.',
								'really-simple-ssl' ),
							'premium'       => true,
...
function rsssl_fields( $load_values = true ) {
	...
	$fields = [
		...
		[
			...
			'help'        => [
				'label' => 'default',
				'url' => 'https://really-simple-ssl.com/definition/what-is-a-mixed-content-scan/',
