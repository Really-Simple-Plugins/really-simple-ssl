...
function rsssl_fields( $load_values = true ) {
	...
	$fields = [
		...
		[
			...
			'group_id' => 'general',
			'type'     => 'checkbox',
			'label'    => __( "Email address for notifications", 'really-simple-ssl' ),
			'tooltip'  => __( "Email address preference for important setting changes and notices.", 'really-simple-ssl' ),
			'disabled' => false,
			'default'  => true,
		],
		[
		...
		[
			...
			'button_text' => __( "Send test mail", "really-simple-ssl" ),
			'label'       => __( "Send test email", 'really-simple-ssl' ),
			'disabled'    => false,
			'default'     => false,
			'condition_action'   => 'hide',
			'react_conditions' => [
