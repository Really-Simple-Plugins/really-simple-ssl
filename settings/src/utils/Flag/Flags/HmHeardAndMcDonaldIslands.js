...
const SvgHmHeardAndMcDonaldIslands = (props) => (
  <svg
  ...
  >
    <mask
      id="HM_-_Heard_and_McDonald_Islands_svg__a"
      width={16}
      height={12}
      x={0}
      y={0}
    ...
    <g mask="url(#HM_-_Heard_and_McDonald_Islands_svg__a)">
      <path
        fill="#2E42A5"
        fillRule="evenodd"
        d="M0 0h16v12H0V0Z"
        clipRule="evenodd"
      />
      <g clipPath="url(#HM_-_Heard_and_McDonald_Islands_svg__b)">
      ...
      <g fill="#F7FCFF" clipPath="url(#HM_-_Heard_and_McDonald_Islands_svg__c)">
    ...
    <defs>
      <clipPath id="HM_-_Heard_and_McDonald_Islands_svg__b">
        <path fill="#fff" d="M0 0h9v7H0z" />
      </clipPath>
      <clipPath id="HM_-_Heard_and_McDonald_Islands_svg__c">
        <path fill="#fff" d="M3 1h12v10H3z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgHmHeardAndMcDonaldIslands;
