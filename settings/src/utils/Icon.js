...
const Icon = (props) => {
    ...
    if (iconName === 'file-search') {
        renderedIcon = {
            html: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 384 512">
                <path
    ...
    if (iconName === 'download') {
        renderedIcon = {
            html: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 512 512">
                <path
    ...
    if (iconName === 'satellite-dish') {
        renderedIcon = {
            html: <svg xmlns="http://www.w3.org/2000/svg" color={iconColors[iconColor]} width="24" height="24"
                       viewBox="0 0 512 512">
                <path
