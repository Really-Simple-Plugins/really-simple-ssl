...
const Icon = (props) => {
  ...
  if (iconName === 'info-open') {
    renderedIcon = {
      html:
        <svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height={iconSize}>
