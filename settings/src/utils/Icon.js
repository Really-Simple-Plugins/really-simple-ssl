...
const Icon = (props) => {
  ...
  if (iconName === 'external-link') {
    ...
    if (iconName === 'file-search') {
        renderedIcon = {
            html: <svg xmlns="http://www.w3.org/2000/svg" height={iconSize} fill="none" viewBox="0 0 384 512">
                <path
    ...
    if (iconName === 'download') {
        renderedIcon = {
            html: <svg xmlns="http://www.w3.org/2000/svg" height={iconSize} fill="none" viewBox="0 0 512 512">
                <path
    ...
    if (iconName === 'satellite-dish') {
        renderedIcon = {
            html: <svg xmlns="http://www.w3.org/2000/svg" color={iconColors[iconColor]} height={iconSize}
                       viewBox="0 0 512 512">
                <path
