...
const ProgressFooter = (props) => {
    ...
    return (
        <>
            ...
            { !rsssl_settings.pro_plugin_active && <a key="progressFooterGoPro" href={rsssl_settings.upgrade_link} target="_blank" rel="noopener noreferrer" className="button button-default">{ __( "Go Pro", "really-simple-ssl" ) }</a>}
